...
namespace BookStore.UserControls
{
    public partial class UC_Author : UserControl
    {
        ...
        private bool CheckThieuThongTin()
        {
            ...
            {
                MessageBox.Show("Tên tác giả không được trống!");
                return false;
            }
            if (txt_maTG.Text.Trim() == "")
            {
                MessageBox.Show("Mã tác giả không được trống!");
                return false;
            }
            if (int.TryParse(txt_maTG.Text, out int receiptid) && receiptid < 0)
            {
            ...
            {
                MessageBox.Show("Mã nhà xuất bản không được trống!");
                return false;
            }    
            return true;
        }
